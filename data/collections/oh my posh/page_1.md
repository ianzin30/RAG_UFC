...
For your convenience, the existing [themes](https://github.com/JanDeDobbeleer/oh-my-posh/tree/main/themes) from [Oh My Posh](https://github.com/JanDeDobbeleer/oh-my-posh/tree/main/themes) have been added to version 4, so you
